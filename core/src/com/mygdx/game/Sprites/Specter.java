...
public class Specter extends Enemy{
    ...
    public Specter(PlayScreen screen, float x, float y) {
        ...
        // for(int i = 0; i < 2; i++)
        //            frames.add(new TextureRegion(screen.getAtlas().findRegion("spectre"), i * 16, 0, 16, 16));
...
//definisco BIT del nemico
        ...
        fdef.filter.maskBits=MyGdxGame.GROUND_BIT |MyGdxGame.PLAYER_BIT|MyGdxGame.ENEMY_BIT;
